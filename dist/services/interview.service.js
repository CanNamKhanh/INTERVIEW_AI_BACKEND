...
exports.deleteInterviewService = exports.endInterviewService = exports.createInterviewService = void 0;
const openai_1 = require("../libs/openai");
const prisma_1 = require("../libs/prisma");
const createInterviewService = async (input) => {
    const { title, position, level, userId, type, yearsOfExperience, category } = input;
    const categoryRecord = await prisma_1.prisma.industryCategory.findFirst({
        where: { name: category },
    });
    if (!categoryRecord) {
...
const endInterviewService = async (interviewId) => {
...
exports.endInterviewService = endInterviewService;
const deleteInterviewService = async (interviewId) => {
    try {
        await prisma_1.prisma.interview.delete({
            where: {
                id: interviewId,
            },
        });
